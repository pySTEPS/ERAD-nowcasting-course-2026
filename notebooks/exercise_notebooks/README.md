...
The notebooks also run outside Colab, on a local checkout of this repository: see "Running the notebooks locally" in the [top-level README](../../README.md). In that case none of the Google Drive steps above apply, and the Colab-only cells skip themselves.
